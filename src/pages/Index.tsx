...
//         <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/8 dark:bg-primary/5 rounded-full blur-3xl animate-pulse"></div>
//         <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-purple-500/8 dark:bg-purple-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
//         <div className="absolute top-1/2 left-3/4 w-64 h-64 bg-blue-500/8 dark:bg-blue-500/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '4s' }}></div>
//         
//         {/* Ocean-like Background Animation */}
//         <div className="absolute inset-0 opacity-20 dark:opacity-10">
//           <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-cyan-400/10 via-blue-500/5 to-purple-600/10 animate-[pulse_8s_ease-in-out_infinite]"></div>
//           <div className="absolute top-1/4 left-1/4 w-3/4 h-3/4 bg-gradient-to-tr from-teal-400/8 via-blue-600/8 to-indigo-500/8 rounded-full blur-3xl animate-[pulse_10s_ease-in-out_infinite] opacity-60" style={{ animationDelay: '2s' }}></div>
...
//           <div className="absolute top-1/3 left-1/5 w-2 h-2 bg-primary/30 rounded-full animate-bounce" style={{ animationDelay: '1s', animationDuration: '3s' }}></div>
//           <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-purple-500/40 rounded-full animate-bounce" style={{ animationDelay: '2s', animationDuration: '4s' }}></div>
//           <div className="absolute bottom-1/4 left-2/3 w-3 h-3 bg-cyan-400/20 rounded-full animate-bounce" style={{ animationDelay: '3s', animationDuration: '5s' }}></div>
//         </div>
//         <div className="absolute inset-0">
//           <div className="absolute top-1/3 left-1/5 w-2 h-2 bg-primary/30 rounded-full animate-bounce" style={{ animationDelay: '1s', animationDuration: '3s' }}></div>
//           <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-purple-500/40 rounded-full animate-bounce" style={{ animationDelay: '2s', animationDuration: '4s' }}></div>
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="absolute bottom-10 left-10 w-4 h-4 bg-blue-400 rounded-full animate-neon-pulse" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 left-10 w-8 h-8 bg-purple-300 rounded-full animate-neon-pulse" style={{ animationDelay: '2s' }} />
